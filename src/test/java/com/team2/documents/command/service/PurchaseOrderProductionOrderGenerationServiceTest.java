...
import com.team2.documents.command.service.ProductionOrderCommandService;
...
class PurchaseOrderProductionOrderGenerationServiceTest {
    ...
    void generateProductionOrder_whenPurchaseOrderIsConfirmed_thenCreatesProductionOrder() {
        ...
        // then
        verify(productionOrderCommandService).save(any(com.team2.documents.entity.ProductionOrder.class));
    }
