...
PI를 기반으로 생성되는 발주 문서입니다. PO 확정 시 CI, PL, 출하지시서가 자동 생성되고 생산지시서는 필요 시 선택 생성됩니다. PK는 문서번호 형식(VARCHAR(30))입니다.
...
PO 확정 후 필요 시 선택 생성되는 생산 지시서입니다. PK는 문서번호 형식(VARCHAR(30))입니다.
