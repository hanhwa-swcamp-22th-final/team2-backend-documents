...
CREATE TABLE purchase_orders (
    po_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE commercial_invoices (
    ci_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE packing_lists (
    pl_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE docs_revision (
    docs_revision_id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    doc_type VARCHAR(50) NOT NULL,
    doc_id BIGINT NOT NULL,
    snapshot_data VARCHAR(4000) NOT NULL,
    created_at DATETIME NOT NULL
);

CREATE TABLE production_orders (
    production_order_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    production_order_code VARCHAR(20) NOT NULL,
    po_id BIGINT,
    ...
    UNIQUE (production_order_code)
);

CREATE TABLE shipment_orders (
    shipment_order_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    shipment_order_code VARCHAR(20) NOT NULL,
    po_id BIGINT,
